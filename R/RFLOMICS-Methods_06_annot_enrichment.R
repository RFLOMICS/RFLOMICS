...
#' @importFrom enrichplot cnetplot dotplot
  ...
  definition = function(object,
    ...
    returnplot <-  switch(
      ...
      "heatplot" = {
          ...
          # df1[["Description"]] <- paste0(df1[["Description"]], "\n(", df1[["ID"]], ")")
          df1 <- do.call("rbind", lapply(1:nrow(df1), FUN = function(i){
          ...
          ggplot(data = df1, aes(x = Gene, y = Category)) +
