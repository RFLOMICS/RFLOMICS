...
RFLOMICS uses extended classes of the [MultiAssayExperiment](https://bioconductor.org/packages/MultiAssayExperiment/)  and [SummarizedExperiment](https://bioconductor.org/packages/SummarizedExperiment/)  classes to ensure efficient data management of heterogeneous data.
...
#### Completeness check
 ...
 are presents. A **Balanced design (recommended)** has an equal number of observations (replicates) for each group.
