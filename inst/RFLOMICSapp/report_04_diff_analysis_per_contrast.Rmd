...
ggsave(diff.plots$Pvalue.hist, filename = paste0(contrastDir,data,"_pval_distr.png"), width = 6, height = 4)
ggsave(diff.plots$MA.plot, filename = paste0(contrastDir,data,"_MA_plot.png"), width = 6, height = 4)
...
ggsave(diff.plots$Volcano.plot, filename = paste0(contrastDir,data,"_Volcano.png"), width = 6, height = 4)
